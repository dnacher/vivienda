                ...
                if (chkBonificacion.isSelected() && convenio.getReglabonificacion() != null) {
                    if (ConfiguracionControl.tieneBonificacion(convenio.getReglabonificacion())) {
                        ...
                        if (total > montoAprox) {
                            ...
                            txtMonto.setText("0");
                            System.err.println("entre aca " + txtMonto.getText());
                        }
        ...
        try {
            ...
            if (sugerido != -1) {
                if (sugerido < saldoRestante) {
                    ...
                    txtMonto.setText(saldoRestante.toString());
                }
...
//            periodo = ConfiguracionControl.devuelvePeriodoActual();
//            unidad = tableGastosComunes.getSelectionModel().getSelectedItem();
//            ccb = new CuotaConvenioBean();
//            convenio = ccb.traerConvenioXUnidad(unidad);
//        } catch (ServiceException ex) {
//            Logger.getLogger(PagoConveniosController.class.getName()).log(Level.SEVERE, null, ex);
//        }
//    }
//
//    public void cargaLabels() {
//        lblPeriodo.setText(String.valueOf(periodo));
...
//        subTotal = 0;
//        if (convenio != null) {
//            if (convenio.getReglabonificacion() != null && ConfiguracionControl.tieneBonificacion(convenio.getReglabonificacion())) {
//                total = ((convenio.getDeudaTotal() - convenio.getSaldoInicial()) / convenio.getCuotas());
//                descuento = ConfiguracionControl.calculaBonificacion(convenio.getReglabonificacion(), total);
//                subTotal = total - descuento;
//            } else {
//                total = ((convenio.getDeudaTotal() - convenio.getSaldoInicial()) / convenio.getCuotas());
//                subTotal = total - descuento;
//            }
//            txtMonto.setText(subTotal.toString());
//        }
//    }
//
//    public void cargaGraficaCuotas() {
...
//    }
//
//    public CuotaConvenioBean getCcb() {
//        return ccb;
//    }
//
//    public void setCcb(CuotaConvenioBean ccb) {
//        this.ccb = ccb;
//    }
//
//    public Integer getDescuento() {
